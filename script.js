var sk = [
  { title: "html", image: "assets/html.png", fontSize: "" },
  { title: "css", image: "assets/css.png", fontSize: "" },
  { title: "javascript", image: "assets/js.png", fontSize: "" },
  { title: "jquery", image: "assets/jquery.png", fontSize: "" },
  { title: "mySQL", image: "assets/mysql.png", fontSize: "" },
  { title: "php", image: "assets/php.png", fontSize: "" },
];
...
var pw = [
  ...
  },
  {
    ...
    disc: 'In this project, my emphasis was on functionality rather than the user interface.<br/>Feel free to explore the project and access the code on my <a href="#">GitHub repository</a>',
    images: [
      "assets/ms0.jpg",
      "assets/ms1.jpg",
      "assets/ms2.jpg",
  ...
  },
  {
    ...
    disc: 'Introducing a web-based daily planner application crafted with HTML, CSS, and JavaScript. Designed to enhance your daily organization, it efficiently categorizes your tasks into key priorities, regular activities, and sports, while also incorporating scheduled tasks and tracking your daily water intake.<br><br>While the primary emphasis was on functionality, please note that design refinement is still in progress, as depicted in the provided screenshots. The app securely stores data within your browser, ensuring accessibility both online and offline. For a closer look at the code or a demonstration video, feel free to explore my GitHub repository by visiting <a href="#">this link</a>',
    images: ["assets/p0.png", "assets/p1.png", "assets/p2.png"],
    bg: "#fff",
  },
  {
    title: "Maher - infinity code",
    disc: "I crafted this portfolio using HTML, CSS, JS, and jQuery. I designed the UI/UX and created a unique logo, showcasing my skills in web development",
    images: ["assets/logo-dark.png"],
    bg: "#000",
  },
  {
    title: "more projects",
    disc: "The projects I've previously shared aren't the sole ones I've undertaken. I've worked on numerous projects and tools, but a significant portion of them is either lost, incomplete, or consists solely of code designed for specific tasks, rendering them impractical to showcase",
...
$(document).ready(function () {
  ...
  var t3 =
    "I'm a full-stack web developer with a specialization in back-end development. Currently, I am pursuing my studies at the Faculty of Electronic Engineering, Department of Computer Science, Monufia University.";
  let i = 0;
  var interval = setInterval(() => {
    if (i < t1.length) {
      ...
      chngchar(
        $("#hintext h4").eq(0),
        i - t1.length - t2.length - 40,
        t3[i - t1.length - t2.length - 40]
      );
    } else {
  ...
  $.each(sk, function (i, val) {
    skills.append(
      `<span><img src="${val.image}"><p style='font-size: ${val.fontSize}px;'>${val.title}</p></span>`
    );
    an.push({
      element: skills.find("span").eq(i),
      animation: { scale: "1", opacity: "1" },
      reverse: { opacity: "0", scale: "0" },
      duration: 500,
      show: 0,
      x: -100,
      class: "",
  ...
  $.each(pw, function (i, val) {
    pwSection.append(
      `<span role="button" onclick="win(${i})" style="background: ${val.bg};"><img src="${val.images[0]}"><div><p>${val.title}</p></div></span>`
    );
    an.push({
      element: pwSection.find("span").eq(i),
      animation: {},
      reverse: {},
      duration: 500,
      x: 0,
